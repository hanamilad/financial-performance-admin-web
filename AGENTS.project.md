...
- الاسم: `financial-performance-admin-web`
- المسار: `admin-web/`
- Skill: `.claude/skills/financial-performance-admin-web/SKILL.md`

## اقرأ قبل أي مهمة

- `../project-docs/workflow/CURRENT_SLICE.md`
- `../project-docs/workflow/DECISIONS_LOG.md`
- وثيقة الشاشات وعقود الـAPI.

## قواعد مختصرة

- Admin Web لمدير النظام فقط.
- App Router + TypeScript Strict.
- RTL عربي.
- Cookies وليس Browser Tokens.
- TanStack Query للـServer State.
- Generated OpenAPI Types.
- لا معادلات مالية أساسية داخل الواجهة.
- لا Repository آخر دون تصريح.
